...
Shader "Fx_Alter_CoreSmoke"
{
	...
	SubShader
	{
		...
		{
			Gradient gradient31 = NewGradient( 0, 5, 2, float4( 1, 0.5990566, 0.7899253, 0 ), float4( 1, 0, 0.8682785, 0.06471352 ), float4( 0, 0.8857895, 0.9019608, 0.40589 ), float4( 0, 0.3771887, 0.4352941, 0.520592 ), float4( 0, 0, 0, 0.997055 ), 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
			...
			o.Emission = ( i.vertexColor * i.vertexColor.a * SampleGradient( gradient31, ( 1.0 - ( ( temp_output_23_0 + _Gradient ) * ( 1.0 - step( temp_output_23_0 , _Float4 ) ) ) ) ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18301
0;0;1920;1019;1388.008;-422.4844;1;True;True
...
Node;AmplifyShaderEditor.Vector2Node;6;-4085.713,1175.44;Inherit;False;Property;_NoiseSpeed;NoiseSpeed;4;0;Create;True;0;0;False;0;False;0,-0.57;0,-0.57;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;1;-3404.846,1102.746;Inherit;True;Property;_NoiseTex;NoiseTex;1;0;Create;True;0;0;False;0;False;-1;None;f42ed942948e9174bbb0c71261dbbeae;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-3154.409,-10.22119;Inherit;False;Property;_Float1;Float 1;6;0;Create;True;0;0;False;0;False;-0.38;-0.38;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-2467.152,228.251;Inherit;False;Property;_Float2;Float 2;5;0;Create;True;0;0;False;0;False;1.41;8.68;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;12;-2603.527,730.6884;Inherit;True;Property;_Mask;Mask;2;0;Create;True;0;0;False;0;False;-1;None;e1cbedc852a6080418e297b104592257;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-1660.935,1071.045;Inherit;False;Property;_Float4;Float 4;8;0;Create;True;0;0;False;0;False;0.07369869;0.0905;0;0.1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-1403.623,769.6404;Inherit;False;Property;_Gradient;Gradient;7;0;Create;True;0;0;False;0;False;0.2;0.28;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GradientNode;31;-914.4811,663.5959;Inherit;False;0;5;2;1,0.5990566,0.7899253,0;1,0,0.8682785,0.06471352;0,0.8857895,0.9019608,0.40589;0,0.3771887,0.4352941,0.520592;0,0,0,0.997055;1,0;1,1;0;1;OBJECT;0
...
Node;AmplifyShaderEditor.VertexColorNode;36;-684.0081,1102.484;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;-498.0081,1099.484;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=D5323C657DAEB7FD14476B2BBBEB9B39D15842CE